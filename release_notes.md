...
- Many formulae (in-sheet and in conditional formatting rules) were redesigned to avoid the use of INDIRECT() (volatile function, computationally expensive).
...
- For in-sheet formulae that require a "Legacy" replacement, the legacy formulae are stored as text near the corresponding cells, or above/below the tables, and highlighted in yellow. This is to facilitate the production of the "Legacy" version of the file when adapting it from the "Excel 365" version.
